...
parameter_types! {
	pub LaunchPeriod: BlockNumber = prod_or_fast!(2 * MINUTES , 2 * MINUTES, "ROC_LAUNCH_PERIOD");
	pub VotingPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 1 * MINUTES, "ROC_VOTING_PERIOD");
	pub FastTrackVotingPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 1 * MINUTES, "ROC_FAST_TRACK_VOTING_PERIOD");
	pub const MinimumDeposit: Balance = 100 * CENTS;
	pub EnactmentPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 1, "ROC_ENACTMENT_PERIOD");
	pub CooloffPeriod: BlockNumber = prod_or_fast!(2 * MINUTES, 1 * MINUTES, "ROC_COOLOFF_PERIOD");
...
parameter_types! {
	pub LeasePeriod: BlockNumber = prod_or_fast!(10 * MINUTES, 1 * MINUTES, "ROC_LEASE_PERIOD");
}
