...
use parachain_template_runtime::{NodeAuthorizationConfig,SudoConfig}; // The genesis config that serves for our pallet.
...
fn testnet_genesis(
	invulvnerables: Vec<(AccountId, AuraId)>,
	...
	parachain_template_runtime::GenesisConfig {
		...
		collator_selection: parachain_template_runtime::CollatorSelectionConfig {
			invulnerables: invulvnerables.iter().cloned().map(|(acc, _)| acc).collect(),
